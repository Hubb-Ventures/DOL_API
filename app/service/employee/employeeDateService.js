...
module.exports.getDetail = function(req, resp){
	...
	if(employeeName){
		...
		var options = {
		  ...
		  "port": null,
		  "path": "/index.cfm?event=ehLCJRExternal.dspQuickCertSearchGridData&&startSearch=1&case_number=&employer_business_name="+ employeeName +"&visa_class_id=&state_id=all&location_range=10&location_zipcode=&job_title=&naic_code=&create_date=undefined&post_end_date=undefined&h1b_data_series=ALL&start_date_from="+ startDate +"&start_date_to="+ endDate+"&end_date_from=mm/dd/yyyy&end_date_to=mm/dd/yyyy&nd=1499959786410&page=1&rows=20&sidx=create_date&sord=desc&nd=1499959786410&_search=false",
		  "headers": {
